                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 text-center">
                                <button type="button" data-modal-target="default-modal"
                                    ...
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-2 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">ตั้งค่า
                                    VIP</button>
                            </td>
