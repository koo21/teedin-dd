                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 text-center">
                                <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">ตั้งต่า
                                    VIP</button>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <?= $summary ?> วัน
                            ...
                            <td class="px-6 py-4  text-center">
                                <label class="inline-flex items-center me-5 cursor-pointer">
                                    <input type="checkbox" value="<?= $row["ap"]; ?>" class="sr-only peer"
                                        <?= $btnVip; ?>>
                                    <span class="me-3 text-sm  text-gray-900 dark:text-gray-300">ไม่อมุมัติ VIP</span>
                                    <div data-id="<?= $row["pd"]; ?>"
                                    ...
                                    <span class="ms-3 text-sm  text-gray-900 dark:text-gray-300">อมุมัติ VIP</span>
                                </label>
                            </td>
