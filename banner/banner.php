                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="flex justify-center my-4">
                            ...
                            <div class="registerForm cursor-pointer text-slate-500 hover:text-blue-600 "><i
                                    class="bi bi-pencil-square"></i> สมัครสมาชิก
                            </div>
                        </div>
                        <div class="showLoginFormAndRegisterForm"></div>
                    </div>
                    <div class="col-md-6 mt-5">
                        <img src="../storage/images/regisert.jpg" class="mb-3 w-full rounded-lg" alt="">
                    </div>
                </div>
            </div>
