...
<form action="searchData.php" method="post">
    <div class="container grid gap-x-8 gap-y-4 mt-4  md:grid md:grid-flow-col md:auto-cols-max md:gap-4 ">
...
<div class="container mt-5 mb-5">
    <div class="col-md-12 ">
        <div class="font-bold text-2xl mb-3">ที่ดิน ให้เช่า</div>
                ...
                <div
                    ...
                    <a href="detail.php?id=<?= $row["pd"] ?>&p=<?= $part ?>">
                        ...
                        <div class="p-3 flex flex-col space-y-10">
                            <div class="xl:h-32 md:h-24 h-28">
                                <div class="mb-2">
                                    ...
                                    <h5
                                        class=" text-lg font-normal tracking-tight text-gray-900 dark:text-white line-clamp-2 lg:line-clamp-none">
                                        <?= $row["ti"] ?></h5>
                                </div>
