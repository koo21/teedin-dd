...
<label for="district" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">* ตำบล/แขวง</label>
<select id="countries" name="district"
    ...
    <option value="<?= $dis ?>"><?= $disName ?></option>
