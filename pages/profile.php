            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div class="mb-3">
                    ...
                    <select id="day" name="day"
                        ...
                        if (!empty($r["bo"])) {
                            $dayEx = explode("-", $r["bo"]);
                            echo '<option value="' . $dayEx[2] . '">' . $dayEx[2] . '</option>';
                            echo '<option value="0">-------</option>';
                        } else {
                            echo '<option value="0">-- วันเกิด --</option>';
                        }
                ...
                <div class="mb-3">
                    ...
                    <select id="month" name="month"
                        ...
                        if (!empty($r["bo"])) {
                            $dayEx = explode("-", $r["bo"]);
                            echo '<option value="' . $dayEx[1] . '">' . $months[(int)$dayEx[1]] . '</option>';
                            echo '<option value="0">-------</option>';
                        } else {
                            echo '<option value="0">-- เดือนเกิด --</option>';
                        }
                ...
                <div class="mb-3">
                    ...
                    <select id="year" name="year"
                        ...
                        if (!empty($r["bo"])) {
                            $dayEx = explode("-", $r["bo"]);
                            echo '<option value="' . $dayEx[0] . '">' . $dayEx[0] . '</option>';
                            echo '<option value="0">-------</option>';
                        } else {
                            echo '<option value="0">-- ปีเกิด --</option>';
                        }
